class RecipesController < ApplicationController
  ...
  def search_results
    ...
    response_hash = HTTParty.get("http://api.bigoven.com/recipes?any_kw=#{@search_terms}&pg=1&rpp=20&api_key=#{ENV["MY_API_KEY"]}")
  ...
  def get_json
    ...
    response = HTTParty.get("http://api.bigoven.com/recipe/#{@recipe_id}?api_key=#{ENV["MY_API_KEY"]}")
